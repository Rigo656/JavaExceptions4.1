...
class ProductManagerTest {
    ...
    //Тесты по теме исключений
    @Test
    public void shouldRemoveById() {
        repository.removeById(3);

        Product[] expected = new Product[]{first, second, fourth, fifth, sixth, seventh, eighth, ninth, tenth, eleventh, twelfth};
